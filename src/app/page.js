...
export default async function DashboardPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      {stats.warnings.length > 0 && <section className={styles.warning}><strong>Banco ainda incompleto</strong><p>Algumas tabelas administrativas ainda precisam das migrations do Rota. Isso é esperado até você aplicá-las no SQL Editor.</p></section>}
    </div>
  );
}
