...
export default async function CasesPage({ searchParams }) {
  ...
  return <div className={styles.page}>
    ...
    <section className={styles.panel}>
      ...
      <p><strong>Continuidade processual:</strong> um recurso é uma nova fase do mesmo processo. Para gerar apelação, agravo, recurso especial ou extraordinário, cite no prompt o ID ou código da fase imediatamente anterior e informe a condição, por exemplo “caso o jogador tenha perdido” ou “a parte contrária recorreu”.</p>
      ...
      <GenerateDraftForm action={generateDraftAction.bind(null, 'case')} entityLabel="caso" buttonLabel="Gerar rascunho" longRunning placeholder="Ex.: Crie um caso intermediário de Direito do Consumidor, de grande repercussão, em primeira instância, para advogado contratado."/>
    </section>
