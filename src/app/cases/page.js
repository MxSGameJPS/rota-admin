...
export default async function CasesPage({ searchParams }) {
  ...
  return <div className={styles.page}>
    ...
    <section className={styles.panel}><h3>Criar rascunho com IA</h3><p>O provider recebe o contrato jogável oficial do Rota. O Admin gera primeiro a estrutura do caso e depois completa cada local em etapas menores. A IA nunca publica sozinha.</p><GenerateDraftForm action={generateDraftAction.bind(null, 'case')} entityLabel="caso" buttonLabel="Gerar rascunho" longRunning placeholder="Ex.: Crie um caso intermediário de Direito Empresarial envolvendo fraude societária, com agravo de instrumento e possibilidade de blindagem de extratos bancários."/></section>
